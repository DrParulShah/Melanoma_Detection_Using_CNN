...
![Class Distribution graph](images/class_distribution.jpg)

![Class Distribution graph](images/class_distribution2.jpg)
...
![First Model Architecture](images/CNN_model1_NoDropOut_NoAugmentation.jpg)
...
![model 1 performance](images/CNN_model1_Training_Performance.jpg)
...
Observations and learnings from Second CNN Model 2(used dropout and custom data augmentation):
![model 2 performance](images/CNN_model2_Training_Performance.jpg)
...
Observations and learnings from Third CNN Model 3 (used dropout & data augmentator):
![model 3 performance](images/CNN_model3_Training_Performance.jpg)
...
- also early stopping may help in case the metric is not improving for a few consecutive epochs

So experimented with some more configuration, performance of each can be seen as follows:

#### Model 3b:
![model 3b performance](images/CNN_model3b_Training_Performance.jpg)

#### Model 3c:
![model 3c performance](images/CNN_model3c_Training_Performance.jpg)

#### Model 3d:
![model 3d performance](images/CNN_model3d_Training_Performance.jpg)


- However, it is still possible to improve the model further, one can experiment with following (could not try everthing as google colab can be used for limited time):
	- different filter sizes
	- different combination of convolutation layers (check what happens when we increase / decrease layers, change number of filters in each layers) 
	- different combination of dense layers 
	- use dropout of different % at different stage of layers


## Conclusions:
- we can conclude that out of six CNN thhat we trained, CNN Model 3d is the best with validation accuracy closest to the training accuracy indicating absence of overfitting. This model is trained without batch normalization.
